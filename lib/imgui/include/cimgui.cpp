...
// Extended
CIMGUI_API void igBeginPieMenuEx( bool released )
{
    return ImGui::BeginPieMenuEx(released);
}
CIMGUI_API void igEndPieMenuEx( void )
{
    return ImGui::EndPieMenuEx();
}
CIMGUI_API bool igBeginPiePopup(const char* pName, ImVec2 center, int iMouseButton, bool released)
{
    return ImGui::BeginPiePopup(pName, center, iMouseButton, released);
}
CIMGUI_API void igEndPiePopup()
{
    return ImGui::EndPiePopup();
}
CIMGUI_API bool igBeginPieMenu(const char* pName, bool bEnabled)
{
    return ImGui::BeginPieMenu(pName, bEnabled);
}
CIMGUI_API void igEndPieMenu()
{
    return ImGui::EndPieMenu();
}
CIMGUI_API bool igPieMenuItem(const char* pName, bool bEnabled)
{
    return ImGui::PieMenuItem(pName, bEnabled);
}
