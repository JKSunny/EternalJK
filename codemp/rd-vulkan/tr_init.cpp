...
#ifdef _DEBUG
	r_g2_shadowdebug					= ri.Cvar_Get( "r_g2_shadowdebug",				"0",						CVAR_TEMP, "" );
	r_g2_shadowedges					= ri.Cvar_Get( "r_g2_shadowedges",				"3",						CVAR_TEMP, "" );
	r_g2_shadowsurf						= ri.Cvar_Get( "r_g2_shadowsurf",				"-1",						CVAR_TEMP, "" );
#endif
