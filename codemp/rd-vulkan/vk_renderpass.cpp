...
#ifdef USE_VK_IMGUI
    if ( vk.render_pass.inspector.handle != VK_NULL_HANDLE ) {
        qvkDestroyRenderPass( vk.device, vk.render_pass.inspector.handle, NULL );
        vk.render_pass.inspector.handle = VK_NULL_HANDLE;
    }
#endif
