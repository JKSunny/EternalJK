...
#define LIST_IMAGES_A_B \
	IMG_DO( PT_VISBUF_B,			  RTX_IMG_NUM_STATIC + 0,  R32G32_UINT,	rg32ui, IMG_WIDTH_MGPU,      IMG_HEIGHT ) \
	IMG_DO( PT_VISBUF_A,			  RTX_IMG_NUM_STATIC + 1,  R32G32_UINT,	rg32ui, IMG_WIDTH_MGPU,      IMG_HEIGHT ) \
